...
func TestBB_Sqrt_Square_Int64_Four_EmitsFourThenEOF(t *testing.T) {
	g := cf.Sqrt(cf.Square(cf.FromSource(cf.Int64(4))))
...
func TestBB_Sqrt_Square_Int64_MinusFour_EmitsFourThenEOF(t *testing.T) {
	g := cf.Sqrt(cf.Square(cf.FromSource(cf.Int64(-4))))
...
func TestBB_Sqrt_Square_Rat64_MinusThreeHalves_Emits_1_2_ThenEOF(t *testing.T) {
	g := cf.Sqrt(cf.Square(cf.FromSource(cf.Rat64(-3, 2))))
